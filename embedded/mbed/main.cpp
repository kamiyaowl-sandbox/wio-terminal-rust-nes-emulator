...
int main()
{
    ...
    volatile KeyEvent key = KeyEvent::PressB;
    key = KeyEvent::PressA;
    ...
    if (key == KeyEvent::PressA) {
        BSP_LCD_DisplayStringAt(0, 30, (uint8_t *)"PressA", CENTER_MODE);
    } else {
        BSP_LCD_DisplayStringAt(0, 30, (uint8_t *)"Press Other", CENTER_MODE);
    }
