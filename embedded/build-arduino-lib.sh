...
cp "target/thumbv7em-none-eabihf/release/librust_nes_emulator_embedded.a" "rust_nes_emulator_embedded/src/cortex-m4/librust_nes_emulator_embedded.a"
cp "target/thumbv7em-none-eabihf/release/librust_nes_emulator_embedded.a" "rust_nes_emulator_embedded/src/cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard/librust_nes_emulator_embedded.a"
